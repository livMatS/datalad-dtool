# -*- coding: utf-8 -*-
#
# datalad_dtool documentation build configuration file, created by
        ...
        try:
            subprocess.run(
                args=[setup_py_path, 'build_manpage',
                     '--cmdsuite', 'datalad_dtool:command_suite',
                     '--manpath', abspath(opj(
...
# built documents.
version = datalad_dtool.__version__
release = version
